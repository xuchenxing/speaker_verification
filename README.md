### About
This project is just a simple python3 version of [speaker-recognition](https://github.com/ppwwyyxx/speaker-recognition) 

### difference with speaker-recognition of python2
For the convenience, removed a lot of features I didn't use.
...
optional arguments:
  ...
  -t TASK, --task TASK  Task to do. Either "enroll" 、"predict"、"real" 、"verify"
  -i INPUT, --input INPUT
  ...
  -p personid
       input the person need to be verified.
